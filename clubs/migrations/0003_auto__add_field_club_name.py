...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.name'
        db.add_column(u'clubs_club', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Arbit', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.name'
        db.delete_column(u'clubs_club', 'name')
