...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MusicRoomSlot.timestamp'
        db.add_column(u'clubs_musicroomslot', 'timestamp',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MusicRoomSlot.timestamp'
        db.delete_column(u'clubs_musicroomslot', 'timestamp')
    ...
    models = {
        ...
        u'clubs.musicroomslot': {
            ...
            'timestamp': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'})
        },
