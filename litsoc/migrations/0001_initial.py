...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'litsoc_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(max_length=40000)),
            ('by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment_by', null=True, to=orm['userprofile.UserProfile'])),
            ('anonymous', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'litsoc', ['Comment'])

        # Adding model 'PhotoModel'
        db.create_table(u'litsoc_photomodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=3000, blank=True)),
            ('by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photo_by', null=True, to=orm['userprofile.UserProfile'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'litsoc', ['PhotoModel'])

        # Adding M2M table for field comments on 'PhotoModel'
        m2m_table_name = db.shorten_name(u'litsoc_photomodel_comments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photomodel', models.ForeignKey(orm[u'litsoc.photomodel'], null=False)),
            ('comment', models.ForeignKey(orm[u'litsoc.comment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['photomodel_id', 'comment_id'])

        # Adding model 'LinkModel'
        db.create_table(u'litsoc_linkmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=300)),
        ))
        db.send_create_signal(u'litsoc', ['LinkModel'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'litsoc_comment')

        # Deleting model 'PhotoModel'
        db.delete_table(u'litsoc_photomodel')

        # Removing M2M table for field comments on 'PhotoModel'
        db.delete_table(db.shorten_name(u'litsoc_photomodel_comments'))

        # Deleting model 'LinkModel'
        db.delete_table(u'litsoc_linkmodel')
