...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userprofile_userprofile', (
            ...
            ('contact_number', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ...
            ('hostel', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('avatar', self.gf('django.db.models.fields.files.ImageField')(default='//avatar/default.jpg', max_length=100)),
        ))
